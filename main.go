...
import (
	"kami-peduli-fe/auth"
	"kami-peduli-fe/campaign"
	"kami-peduli-fe/handler"
	"kami-peduli-fe/helper"
	"kami-peduli-fe/payment"
	"kami-peduli-fe/transaction"
	"kami-peduli-fe/user"
	"log"
	"net/http"
	"os"
	...
	webHandler "kami-peduli-fe/web/handler"
...
func main() {
	...
	router.Use(sessions.Sessions("kami-peduli-fe", cookieStore))
